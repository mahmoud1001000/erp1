<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('TaxRateController@store'), 'method' => 'post', 'id' => 'tax_rate_add_form_inst' ]) !!}

    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">فوائد الأقساك</h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        {!! Form::label('amount', __( 'عدد الشهور لفائدة القسط فقط' ) . ':') !!} @show_tooltip('خاص بفائدة القسط ')
          {!! Form::text('count_months', null, ['class' => 'form-control input_number']); !!}
      </div>
      ...
      <div class="form-group">
        <div class="checkbox">
          <label>
             {!! Form::checkbox('is_composite', 1, false, [ 'class' => 'input_icheck']); !!} @lang( 'فايدة مركبة' )
          </label> @show_tooltip(__('lang_v1.for_tax_group_only_help'))
        </div>
      </div>
    </div>
