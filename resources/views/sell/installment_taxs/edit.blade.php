<div class="modal-dialog" role="document">
  ...
  <div class="form-group">
        {!! Form::label('amount', __( 'عدد الشهور' ) . ':') !!} @show_tooltip('خاص بضريبة القسط ')
          {!! Form::text('count_months',  $tax_rate->count_months, ['class' => 'form-control input_number']); !!}
      </div>
      <div class="form-group">
        <div class="checkbox">
          <label>
    ...
    <div class="form-group">
        <div class="checkbox">
          <label>
             {!! Form::checkbox('is_composite', 1, !empty($tax_rate->is_composite), [ 'class' => 'input_icheck']); !!} فايدة مركبة
