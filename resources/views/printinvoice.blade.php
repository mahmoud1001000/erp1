    ...
    <div class="ticket" style="margin:5px!important;padding: 5px">
        {{--Logo --}}
            ...
            <div class="text-box centered">
                <img style="max-height: 100px; width: auto;" src="{{asset('upload/')}}" alt="Logo">
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6 " >
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 ">
                            <div class="text-box invoice_no_prefex div-content">
                                <p class="centered">
                                <span class="headings"><strong>
