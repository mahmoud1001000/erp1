					...
					<div style="overflow: hidden !important;display: flex; flex-wrap: wrap;align-content: center;width: {{$barcode_details->width * 1}}cm; height: {{$barcode_details->height * 1}}cm; justify-content: center;">
					  <div style="font-family: Segoe UI Semibold;">
						...
						@if($print['price_type'] == 'inclusive')
							...
							{{-- Barcode --}}
							<img style="max-width:90% !important;height: 30px !important; display: block;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($page_product->sub_sku, $page_product->barcode_type, 1,30, array(0, 0, 0), false)}}">
