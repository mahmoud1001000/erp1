...
@section('content')
   @include('inventory::partials.style')
       ...
       <div class="row">
                ...
                @component('components.filters', ['title' => __('report.filters')])
                    <div class="col-md-3" >
                        <div class="form-group">
                            {!! Form::label('locations',' الفرع :') !!}
                            {!! Form::select('locations',$locations, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('user','المستحدم :') !!}
                            {!! Form::select('user', $users, null, ['class' => 'form-control select2', 'style' => 'width:100%',  'placeholder' => __('lang_v1.all')]); !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        <div id="getmore" style="margin: auto;margin-top: 10px" >
           <button class="btn btn-success" onclick="getproducts()"> @lang('inventory::lang.get_more') </button>
            <button class="btn btn-danger" onclick="getallproducts()"><i class="fa fa-refresh fa-spin"></i> @lang('inventory::lang.get_all') </button>
        </div>
