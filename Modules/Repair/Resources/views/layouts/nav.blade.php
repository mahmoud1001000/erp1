            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @can('job_sheet.create')
                        ...
                        <li @if(request()->segment(2) == 'guarantee' && request()->segment(3) == 'create') class="active" @endif>
                            <a href="{{action('\Modules\Repair\Http\Controllers\GuaranteeController@index')}}">
                                الضمان
                            </a>
                        </li>
                    @endcan
                    ...
                    @endif
                    @if(auth()->user()->can('repair_setting.view'))
