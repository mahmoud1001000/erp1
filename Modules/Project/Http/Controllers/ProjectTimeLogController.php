                    ...
                    ->addColumn('action', function ($row) use ($can_crud) {
                        ...
                        if ($can_crud) {
                            $html .= '<ul class="dropdown-menu dropdown-menu-left" role="menu">
                                <li>
                                    <a data-href="' . action('\Modules\Project\Http\Controllers\ProjectTimeLogController@edit', [$row->id, 'project_id' => $row->project_id]) . '" class="cursor-pointer time_log_btn">
                                        <i class="fa fa-edit"></i>
                                        '.__("messages.edit").'
                                    </a>
                                </li>
                                <li>
                                    <a data-href="' . action('\Modules\Project\Http\Controllers\ProjectTimeLogController@destroy', [$row->id]) . '"  id="delete_a_time_log" class="cursor-pointer">
