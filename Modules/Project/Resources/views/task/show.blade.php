    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h3 class="modal-title">
                ...
                <button data-href="{{action('\Modules\Project\Http\Controllers\TaskController@edit', [$project_task->id, 'project_id' => $project_task->project_id])}}" class="cursor-pointer edit_a_task_from_view_task mr-16 btn btn-sm btn-primary pull-right">
