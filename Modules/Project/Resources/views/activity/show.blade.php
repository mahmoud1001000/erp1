			...
			<div class="timeline-item">
				...
				<div class="timeline-body timeline-body-custom-color">
					...
					@elseif($activity->subject_type == 'Modules\Project\Entities\ProjectTask')
						...
						@if($activity->description == 'created')
							<a data-href='{{action("\Modules\Project\Http\Controllers\TaskController@show", [$activity->subject->id, "project_id" => $activity->subject->project_id])}}' class="cursor-pointer view_a_project_task text-black">
