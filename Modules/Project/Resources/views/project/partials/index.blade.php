			...
			<div class="col-md-4 eq-height-col">
				<div class="box box-solid box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">
							<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id])}}">
							...
							<div class="dropdown">
								  ...
								  <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="action">
								    ...
								    @can('project.edit_project')
									    <li>
									    	<a data-href="{{action('\Modules\Project\Http\Controllers\ProjectController@edit', [$project->id])}}" class="cursor-pointer edit_a_project">
								    ...
								    @can('project.delete_project')
									    <li>
									    	<a data-href="{{action('\Modules\Project\Http\Controllers\ProjectController@destroy', [$project->id])}}" class="cursor-pointer delete_a_project">
									...
									<li class="divider"></li>
									<li>
								    	<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [ $project->id]).'?view=overview'}}">
								    		<i class="fas fa-tachometer-alt"></i>
								    		@lang('project::lang.overview')
								    	</a>
								    </li>
								    <li>
								    	<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=activities'}}">
								    		<i class="fas fa-chart-line"></i>
								    		@lang('lang_v1.activities')
								    	</a>
								    </li>
								    <li>
								    	<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=project_task'}}">
								    ...
								    @if(isset($project->settings['enable_timelog']) && $project->settings['enable_timelog'])
								    	<li>
									    	<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=time_log'}}">
								    ...
								    @if(isset($project->settings['enable_notes_documents']) && $project->settings['enable_notes_documents'])
								    	<li>
									    	<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=documents_and_notes'}}">
								    ...
								    @if((isset($project->settings['enable_invoice']) && $project->settings['enable_invoice']) && $project->is_lead_or_admin)
								    	<li>
									    	<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=project_invoices'}}">
								    ...
								    @if($project->is_lead_or_admin)
								    	<li>
								    		<a href="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=project_settings'}}">
