                ...
                <ul class="nav nav-tabs">
                    <li class="
                        ...
                        @else
                            ''
                        @endif">
                        <a href="#project_overview" data-toggle="tab" aria-expanded="true" data-url="{{action('\Modules\Project\Http\Controllers\ProjectController@show', [$project->id]).'?view=overview'}}">
