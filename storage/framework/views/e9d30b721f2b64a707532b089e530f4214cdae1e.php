<?php $__env->startSection('title', __('ايصال ضمان')); ?>
...
<section class="content">
    ...
    <?php else: ?>
        ...
        ?>
    <?php endif; ?>
    <?php echo Form::open(['action' => '\Modules\Repair\Http\Controllers\GuaranteeController@store', 'id' => 'job_sheet_form', 'method' => 'post', 'files' => true]); ?>
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <?php echo Form::label('variation_id', __('المنتج') . ':'); ?>

                            <?php echo Form::select('variation_id',[], null, ['id'=>'variation_id','class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); ?>

                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <?php echo Form::label('invoice_id', __('الفاتورة ') . ':'); ?>

                            <?php echo Form::select('transaction_id', [],null, ['id'=>'invoice_id','class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); ?>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <?php echo Form::label('supplier_id', __('المورد') . ':'); ?>

                            <?php echo Form::select('supplier_id',[], null, ['id'=>'supplier_id','class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); ?>
...
<?php $__env->startSection('javascript'); ?>
    <script src="<?php echo e(asset('js/repair_module.js?v=' . $asset_v), false); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/Modules/Repair/Providers/../Resources/views/guarantee/create.blade.php ENDPATH**/ ?>