...
<section class="content-header">
    <h1><?php echo app('translator')->get( 'account.trial_balance'); ?>
    </h1>
</section>
            ...
            <table class="table table-border-center-col no-border table-pl-12" id="trial_balance_table">
                <thead>
                    <tr class="bg-gray">
                        ...
                        <th><?php echo app('translator')->get('account.creditor'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/resources/views/account_reports/trial_balance.blade.php ENDPATH**/ ?>