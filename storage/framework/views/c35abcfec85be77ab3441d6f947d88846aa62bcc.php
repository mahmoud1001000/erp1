...
<section class="content">
	<h4>
		<?php echo app('translator')->get('essentials::lang.all_memos'); ?>
		<small> <?php echo app('translator')->get('essentials::lang.manage_memos'); ?></small>
	</h4>
		<div class="box box-solid">
			<div class="box-header">
				<h4 class="box-title"><?php echo app('translator')->get('essentials::lang.all_memos'); ?></h4>
			...
			<div class="box-body">
				...
				<div class="row">
					...
					<table class="table table-bordered table-striped documents">
						<thead>
							<tr>
								<th> <?php echo app('translator')->get('essentials::lang.heading'); ?></th>
								<th> <?php echo app('translator')->get('essentials::lang.description'); ?></th>
								<th> <?php echo app('translator')->get('essentials::lang.created_at'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/Modules/Essentials/Providers/../Resources/views/memos/index.blade.php ENDPATH**/ ?>