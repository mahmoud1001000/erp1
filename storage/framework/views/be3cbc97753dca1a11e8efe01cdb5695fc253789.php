        ...
        <div class="row eq-height-row">
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col" >
                ...
                <div class="left-col-content login-header"> 
                    ...
                    <?php else: ?>
                       <?php echo e(config('app.name', 'أم زد سوفت'), false); ?>
...
</html><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/resources/views/layouts/auth2_old.blade.php ENDPATH**/ ?>