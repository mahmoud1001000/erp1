      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <img width="100" src="/uploads/invoice_logos/<?php echo e($invoice_layout->logo, false); ?>">
          </div>
        </div>
      ...
      <div class="box-body">
        ...
        <div class="col-sm-4" style="display: none">
          <div class="form-group">
            ...
            <?php echo Form::text('tax_number', $invoice_layout->tax_number, ['class' => 'form-control',]); ?>
        ...
        <div class="col-sm-4" style="display: none">
          <div class="form-group">
            ...
            <?php echo Form::text('commercial_register',$invoice_layout->commercial_register, ['class' => 'form-control',
              ]); ?>
        ...
        <div class="col-sm-4"  style="display: none">
          <div class="form-group">
            ...
            <?php echo Form::text('tax_number2', $invoice_layout->tax_number2, ['class' => 'form-control' ]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u373816316/domains/erp4anyone.com/public_html/4any/resources/views/invoice_layout/edit.blade.php ENDPATH**/ ?>