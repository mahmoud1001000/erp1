...
<section class="content-header">
    <h1><?php echo app('translator')->get('lang_v1.purchase_return'); ?></h1>
</section>
			            ...
			            <tr>
			              	...
			              	<td>
					            ...
					            <?php if($purchase_line->product->enable_stock): ?> 
			              			...
			              			data-msg-max-value="<?php echo app('translator')->get('validation.custom-messages.quantity_not_available', ['qty' => $purchase_line->formatted_qty_available, 'unit' => $unit_name ]); ?>" 
			              		<?php endif; ?>
					            >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/resources/views/purchase_return/add.blade.php ENDPATH**/ ?>