        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <?php echo Form::text('sku2',$product->sku2, ['class' => 'form-control',
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <small><p class="help-block"><?php echo app('translator')->get('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]); ?>. <?php echo app('translator')->get('lang_v1.aspect_ratio_should_be_1_1'); ?> <?php if(!empty($product->image)): ?> <br> <?php echo app('translator')->get('lang_v1.previous_image_will_be_replaced'); ?> <?php endif; ?></p></small>
                                   <img width="100" src="/uploads/img/<?php echo e($product->image, false); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/resources/views/product/edit.blade.php ENDPATH**/ ?>