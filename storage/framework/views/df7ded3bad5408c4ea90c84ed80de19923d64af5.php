                ...
                ?>
                    ...
                    <li>
                        <a href="#repair_device_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->get('repair::lang.devices'); ?>
                            <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                ...
                ?>
                    ...
                    <li>
                        <a href="#repair_device_models_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->get('repair::lang.device_models'); ?>
                            <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                ...
                ?>
                    ...
                    <li>
                        <a href="#repair_settings_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->get('repair::lang.repair_settings'); ?>
                        </a>
                    </li>
                </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/Modules/Repair/Providers/../Resources/views/settings/index.blade.php ENDPATH**/ ?>