...
<section class="content-header">
    <h1><?php echo app('translator')->get('barcode.add_barcode_setting'); ?></h1>
    <!-- <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('is_continuous', 1, false, ['id' => 'is_continuous']); ?> <?php echo app('translator')->get('barcode.is_continuous'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217138193/domains/mzgr0up.com/public_html/erp1/resources/views/barcode/create.blade.php ENDPATH**/ ?>